  ...
  return (
    <div className="popup-box">
      <div className="box">
        ...
        {props.productId == 1 ?
        <div>
            <h3>Investment Advisory à Strategize your future</h3>
        ...
        {props.productId == 2 ?
        <div>
            <h3>Portfolio Management and Equity portfolio for Investment</h3>
            <p>With this service we’ll manage your money and provide guaranteed return of 10% per annum. We’ll charge 2-3 % of your profit (along with stipulated fees) to give you timely entry and exit plan of a particular script as per our research and analysis.</p>
        ...
        {props.productId == 3 ?
        <div>
            <h3>Income Generation and Steps towards Financial Freedom</h3>
